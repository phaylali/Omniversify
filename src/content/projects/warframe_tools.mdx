...
description: "A modern Flutter application 🦋 for managing your Warframe void relic inventory 🔮. Track relics across all conditions (Intact ⚪, Exceptional 🥉, Flawless 🥈, Radiant 🌟), sync with a PocketBase backend ☁️, and organize your farming sessions 🚜 efficiently ⚡."
...
repo: "https://github.com/phaylali/warframetools"
...
<div class="flex gap-4 justify-center py-4">
  <div class="w-[180px] h-[380px] rounded-2xl border-2 border-gold/30 bg-black/30 overflow-hidden cursor-pointer hover:border-gold/60 transition-colors" onclick="openImageViewer(this)" data-src="https://play-lh.googleusercontent.com/0MiWFR3iPgKkO6cDp41ANVrCIsZChzrkkvXxgMZhorC1G5RIL5YPEVm0NTAY4Q0qFG9CAx5_1fJ-us9pMzkgvA=w2560-h1440-rw" data-alt="Screenshot 1">
    <img src="https://play-lh.googleusercontent.com/0MiWFR3iPgKkO6cDp41ANVrCIsZChzrkkvXxgMZhorC1G5RIL5YPEVm0NTAY4Q0qFG9CAx5_1fJ-us9pMzkgvA=w2560-h1440-rw" alt="Screenshot 1" class="w-full h-full object-cover" />
  </div>
  <div class="w-[180px] h-[380px] rounded-2xl border-2 border-gold/30 bg-black/30 overflow-hidden cursor-pointer hover:border-gold/60 transition-colors" onclick="openImageViewer(this)" data-src="https://play-lh.googleusercontent.com/ikVtN4RHOqRPRXXWdNIQ9kNH8SkaoTcetS-FhBZHgSpAsqI7vzOL3wQCl0LASFDjZ9ZGYGb79vdpLOiO2Ks2Mw=w2560-h1440-rw" data-alt="Screenshot 2">
    <img src="https://play-lh.googleusercontent.com/ikVtN4RHOqRPRXXWdNIQ9kNH8SkaoTcetS-FhBZHgSpAsqI7vzOL3wQCl0LASFDjZ9ZGYGb79vdpLOiO2Ks2Mw=w2560-h1440-rw" alt="Screenshot 2" class="w-full h-full object-cover" />
  </div>
  <div class="w-[180px] h-[380px] rounded-2xl border-2 border-gold/30 bg-black/30 overflow-hidden cursor-pointer hover:border-gold/60 transition-colors" onclick="openImageViewer(this)" data-src="https://play-lh.googleusercontent.com/tIJiP-o39-YtUBct-_kpN9pNcDITSB4IZnheNxeIKIbab8IFdfrO53OQFNjLnfAMZgFsM-eqU7GR1B51MO2PcA=w2560-h1440-rw" data-alt="Screenshot 3">
    <img src="https://play-lh.googleusercontent.com/tIJiP-o39-YtUBct-_kpN9pNcDITSB4IZnheNxeIKIbab8IFdfrO53OQFNjLnfAMZgFsM-eqU7GR1B51MO2PcA=w2560-h1440-rw" alt="Screenshot 3" class="w-full h-full object-cover" />
  </div>
</div>
...
1. **Clone the repository**
   ```bash
   git clone https://github.com/phaylali/warframetools.git
   cd warframetools
   ```
...
3. **Configure the app**
   ...
   - On first launch, app loads from bundled 
   ```
...
This project is licensed under the MIT License - see the [LICENSE](https://github.com/phaylali/warframetools/blob/main/LICENSE.md) file for details.
