...
Our primary code editor — a fast, collaborative IDE built in Rust with native support for Astro, React, TypeScript, and Tailwind CSS.
...
3D creation suite used for modeling, sculpting, shading, and rendering game assets and promotional visuals.

### [GIMP](https://www.gimp.org/)

Raster graphics editor for image manipulation, texture creation, and screenshot preparation.
